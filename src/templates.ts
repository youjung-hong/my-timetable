...
export const TIMETABLE_INNERHTML = (_startHour: number = 0): string => {
...
export const TIMELINE_INNERHTML = (timeline: Timeline, left: number | string, width: number | string): string =>
