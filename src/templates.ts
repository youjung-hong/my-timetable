...
export const TIMETABLE_INNERHTML = `<div class="timetable">
...
export const TIMELINE_INNERHTML = (timeline: ITimeline, left: number | string, width: number | string) => `<div class="timeline" style="left: ${left}; width: ${width}; background-color: ${timeline.color};" data-timeline-id="${timeline.id}"></div>`